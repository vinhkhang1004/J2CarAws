...
# Triển khai Hệ thống Thương mại Điện tử Phụ tùng Ô tô (J2Car AutoParts) trên AWS

Chào mừng các bạn đến với tài liệu hướng dẫn thực hành Workshop triển khai ứng dụng thương mại điện tử **J2Car AutoParts** trên hạ tầng điện toán đám mây Amazon Web Services (AWS). 
...
1. **[Giới thiệu & Kiến trúc AWS](5.1-overview/)**
   * Tổng quan dự án J2Car AutoParts và phân tích chi tiết vai trò các tầng dịch vụ AWS.
